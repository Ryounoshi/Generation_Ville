#ifndef ETAGEHEXATWISTED_H
#define ETAGEHEXATWISTED_H
...
class EtageHexaTwisted
{
public:
    EtageHexaTwisted(const Vector3D &p0, const Vector3D &p1, const Vector3D &p2, const Vector3D &p3, const Vector3D &p4, const Vector3D &p5, float hauteur, BatParameter *par, int noEtage, int type);
    Mesh generate();
private:
    Mesh ourMesh;
