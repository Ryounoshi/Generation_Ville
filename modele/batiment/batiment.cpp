...
Mesh Batiment::generate()
{
    ...
    if(longueur <= largeur*2 && largeur <= longueur*2 && rand()%2){
        ...
        Vector3D hp1 = longueur*dirlongueur/6.0 - largeur*dirlargeur/2.0;
        Vector3D hp2 = -longueur*dirlongueur/6.0 - largeur*dirlargeur/2.0;
        Vector3D hp3 = -longueur*dirlongueur/2.0;
        Vector3D hp4 = -longueur*dirlongueur/6.0 + largeur*dirlargeur/2.0;
        Vector3D hp5 = longueur*dirlongueur/6.0 + largeur*dirlargeur/2.0;
