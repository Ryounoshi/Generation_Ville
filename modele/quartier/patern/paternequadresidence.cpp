...
Mesh PaterneQuadResidence::paternTroisBatiment(){
    ...
    Vector2D p0p3 = notreQuadrangle[0] - notreQuadrangle[3];
    Vector2D p1p2 = notreQuadrangle[1] - notreQuadrangle[2];

    Vector2D p2p1 = notreQuadrangle[2] - notreQuadrangle[1];
    Vector2D p2p3 = notreQuadrangle[2] - notreQuadrangle[3];

    Vector2D p3p2 = notreQuadrangle[3] - notreQuadrangle[2];
    Vector2D p3p1 = notreQuadrangle[3] - notreQuadrangle[1];

    p0p3 = p0p3.normalise(); p1p2 = p1p2.normalise();
    p2p1 = p2p1.normalise(); p2p3 = p2p3.normalise();
    p3p2 = p3p2.normalise(); p3p1 = p3p1.normalise();

    float dp0p3 = (centre[0]-notreQuadrangle[3]).scalareProduct(p0p3);
    float dp1p2 = (centre[1]-notreQuadrangle[2]).scalareProduct(p1p2);
    float dp2p1 = (centre[2]-notreQuadrangle[1]).scalareProduct(p2p1);
    float dp2p3 = (centre[2]-notreQuadrangle[3]).scalareProduct(p2p3);
    float dp3p2 = (centre[3]-notreQuadrangle[2]).scalareProduct(p3p2);
    float dp3p1 = (centre[3]-notreQuadrangle[1]).scalareProduct(p3p1);

    Vector2D p2B1 = notreQuadrangle[0] + p0p3*dp0p3;
    Vector2D p4B1 = notreQuadrangle[1] + p2p1*dp1p2;
    ...
    Vector2D p2B2 = notreQuadrangle[2] + p2p1*dp2p1;
    Vector2D p4B2 = notreQuadrangle[2] + p2p3*dp2p3;
    ...
    Vector2D p4B3 = notreQuadrangle[3] + p3p1*dp3p1;
...
Mesh PaterneQuadResidence::paternDeuxBatimentDiagonale(){
    ...
    Vector2D p1p0 = notreQuadrangle[0] - notreQuadrangle[3];

    Vector2D p3p2 = notreQuadrangle[2] - notreQuadrangle[1];

    p1p0 = p1p0.normalise();
    p3p2 = p3p2.normalise();

    float dp1p0 = (centre[1]-notreQuadrangle[0]).scalareProduct(p1p0);
    float dp3p2 = (centre[3]-notreQuadrangle[2]).scalareProduct(p3p2);
